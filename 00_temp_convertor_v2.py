...
class HistoryExport:
    ...
    # change calculation list into a string do that it
    ...
    def write_to_file(self):
        # retrieves date, filename and calculation history
        filename = self.var_filename.get()
        generate_date = self.var_todays_date.get()
